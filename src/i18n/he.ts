...
export const he: Catalogue<Messages, 'he'> = {
  ...
  'push.needsHttps': 'התראות כשהלשונית סגורה דורשות חיבור מאובטח. בכתובת רגילה ברשת המקומית הדפדפן לא יריץ service worker כלל — יש להגיע לכאן דרך https (שם של Tailscale או מנהרה, שניהם עובדים).',
  'push.heading': 'גם כשהלשונית סגורה',
  'push.explain': 'השרת הזה ממשיך לעקוב אחרי GitHub ומודיע לך גם כששום דבר לא פתוח.',
  'push.enable': 'הפעלה',
  'push.disable': 'כיבוי',
  'push.on': 'פעיל. תקבל התראה גם כשהלשונית הזו סגורה.',
  'push.failed': 'זה לא עבד. ייתכן שהשרת נעצר.',
  'push.denied': 'הדפדפן סירב לתת הרשאה להצגת התראות.',
  'push.differentAccount': 'השרת הזה עוקב בתור {who}, ולא בתור החשבון המחובר כאן.',
  'notify.label': 'התראות',
