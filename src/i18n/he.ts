...
export const he: Catalogue<Messages, 'he'> = {
  ...
  'gate.stay': 'להישאר מחובר במכשיר הזה',
  'gate.storageKept': 'הטוקן נשמר ב‑<1>localStorage</1> של הדפדפן הזה, כך שהוא שורד סגירת לשונית, ונשלח רק אל <2>api.github.com</2>. אפשר לבטל את הסימון למעלה כדי לחזור לשמירה בלשונית הזו בלבד.',
  'action.clear': 'ניקוי',
  'action.save': 'שמירה',
  'action.add': 'הוספה',
