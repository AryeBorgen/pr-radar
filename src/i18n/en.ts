...
export const en = {
  ...
  'push.needsHttps': 'Notifications with the tab closed need a secure connection. Over a plain address on your network the browser will not run a service worker at all — reach this over https (a Tailscale name or a tunnel both work).',
  'push.heading': 'While the tab is closed',
  'push.explain': 'This server keeps watching GitHub and notifies you even when nothing is open.',
  'push.enable': 'Turn on',
  'push.disable': 'Turn off',
  'push.on': 'On. You will be told even with this tab closed.',
  'push.failed': 'That did not work. The server may have stopped.',
  'push.denied': 'The browser refused permission to show notifications.',
  'push.differentAccount': 'This server watches as {who}, not the account signed in here.',
